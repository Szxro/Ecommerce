...
namespace Ecommerce.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250421162910_Remove_Nullability_TotalPrice")]
    partial class Remove_Nullability_TotalPrice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.ShoppingCartDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_shopping_cart_details");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_shopping_cart_details_product_id");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.ProductImage", b =>
                {
                    b.HasOne("Ecommerce.Domain.Entities.Image", "Image")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_image_image_image_id");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.ShoppingCartDetails", b =>
                {
                    b.HasOne("Ecommerce.Domain.Entities.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_shopping_cart_details_product_product_id");
                    ...
                    b.HasOne("Ecommerce.Domain.Entities.ShoppingCart", "ShoppingCart")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_shopping_cart_details_shopping_cart_shopping_cart_id");
