...
namespace Ecommerce.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250415151702_Remove_Product_Category_UX")]
    partial class Remove_Product_Category_UX
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.ShoppingCartProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_shopping_cart_product");
            ...
            modelBuilder.Entity("Ecommerce.Domain.Entities.ShoppingCartProduct", b =>
                {
                    b.HasOne("Ecommerce.Domain.Entities.Product", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_shopping_cart_product_product_product_id");
                    ...
                    b.HasOne("Ecommerce.Domain.Entities.ShoppingCart", "ShoppingCart")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_shopping_cart_product_shopping_cart_shopping_cart_id");
